# TimeBeam Synchronization Testing

This directory contains comprehensive unit tests for the timer synchronization functionality in TimeBeam, ensuring reliable cross-device timer state synchronization.
...
```bash
cd back-end
mvn test -Dtest="com.sparkage.timebeam.application.service.*Test"
```
