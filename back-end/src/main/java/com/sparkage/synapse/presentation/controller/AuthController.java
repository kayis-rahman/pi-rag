package com.sparkage.synapse.presentation.controller;
...
import com.sparkage.synapse.application.service.AuthService;
import com.sparkage.synapse.application.service.UserService;
import com.sparkage.synapse.domain.model.User;
import com.sparkage.synapse.infrastructure.config.AppLogger;
import com.sparkage.synapse.infrastructure.external.JwtUtils;
import com.sparkage.synapse.infrastructure.persistence.RefreshToken;
import com.sparkage.synapse.infrastructure.persistence.RefreshTokenRepository;
import com.sparkage.synapse.presentation.dto.AuthRequests;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> health() {
        return ResponseEntity.ok(Map.of("status", "ok", "service", "synapse-backend"));
    }
