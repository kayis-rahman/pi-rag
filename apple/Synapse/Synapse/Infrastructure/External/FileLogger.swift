...
/// File logging utility for Synapse iOS/macOS apps
...
final class FileLogger {
    private static let logger = os.Logger(subsystem: "com.sparkage.synapse", category: "filelogger")
    ...
    private static var logFileURL: URL {
        get {
            ...
            let logsPath = documentsPath.appendingPathComponent("SynapseLogs")
            #elseif os(macOS)
            ...
            return logsPath.appendingPathComponent("synapse_\(platform.lowercased()).log")
        }
    }
    ...
    static func initialize() {
        ...
        do {
            ...
            let logContent = "=== Synapse App Launch - \(Date()) ===\n"
